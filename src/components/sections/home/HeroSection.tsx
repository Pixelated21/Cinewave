...
export default function HeroSection({ trending }: { trending: Trending[] }) {
    return (
        <>
                                    ...
                                    <div className="flex h-full justify-between px-4 sm:px-8 xl:px-2">
                                        <div className="flex flex-col gap-y-2 md:gap-y-8 justify-end">
                                            ...
                                            <div className="flex gap-2 items-center">
                                                ...
                                                <div className="">
                                                    <AddToWatchListButton resource_id={movie.id.toString()} poster_path={movie.poster_path} backdrop_path={movie.backdrop_path} release_date={getYear(movie.release_date)} title={movie.title} resource_type='movie' />
                                                </div>
            ...
            <div className="flex flex-col gap-y-2 w-10 absolute right-5 bottom-5 z-10">
                <Button className="p-3 swiper-button-next-custom bg-gray-600 hover:bg-gray-500 opacity-50 hover:opacity-100"><ChevronRightIcon className="h-8 w-8" /></Button>
                <Button className="p-3 swiper-button-prev-custom bg-gray-600 hover:bg-gray-500 opacity-50 hover:opacity-100"><ChevronLeftIcon className="h-5 w-5" /></Button>
            </div>
        </>
    );
}
